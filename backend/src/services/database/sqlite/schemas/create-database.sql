...
-- This script initializes the complete SQLite database schema for the Kyan Jukebox application
...
VALUES (1, 'Initial database schema creation');
...
-- Insert BRH (Big Red Head) default user if not exists
INSERT OR IGNORE INTO users (id, fullname, email)
VALUES ('brh', 'Big Red Head', 'brh@kyan.com');

-- Insert initial state setting if not exists
INSERT OR IGNORE INTO settings (key, value)
VALUES ('state', '{"trackSeeds":[],"currentTrack":null,"currentTracklist":[]}');
